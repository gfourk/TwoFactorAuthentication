...
public class HY457Certificate implements Serializable {
	...
	/*
	 * public class X509V1CreateExample { public static X509Certificate
	 * generateV1Certificate(KeyPair pair) throws InvalidKeyException,
	 * NoSuchProviderException, SignatureException { // generate the certificate
	 * 
	 * 
