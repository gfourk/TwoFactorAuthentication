...
public class TwoFAClient {
    ...
    private int i = 0;
        ...
        public String register(String PIN, String port,String host){
            ...
            } catch(Exception e){Log.log("Error (0)",1); return null;}
          ...
          // ================================================================================ #2 in
           try {
            ...
            response =new String(
                    ...
                    ,this.server_key));
            } catch (Exception e){Log.log("Error (6)",1); return null; }
            ...
            if(st.hasMoreTokens())
                ...
                } catch (Exception e){Log.log("Error (7)",1); return null; }
            else{
                Log.log("Error (8)",1); return null;
            }

            if(nonce_1 != nonce+1) {
                Log.log("Error (9)",1); return null;
            }
            ...
            //============================================================================= #3 out
                ...
                catch(Exception e){Log.log("Error (10)",1); return null;}
    ...
    public String get_OTP(String PIN, String port,String host){
            ...
            try{
            port_number = Integer.parseInt(port);
            } catch(Exception e){Log.log("Error (30)",1); return null;}
	    ...
	    String response = null;
            ...
            Log.log("Error (34)",1); return null;}
          ...
          // ================================================================================ #2 in
           try {
            ...
            response =new String(
                    ...
                    utils.toByte(response), this.kp.getPrivate())
                    ,this.server_key));
            } catch (Exception e){Log.log("Error (36)",1); return null; }
            ...
            if(st.hasMoreTokens())
                try{
                sessionKey = (AESKey) utils.bytesToObject(utils.toByte(st.nextToken()));
                } catch (Exception e){Log.log("Error (37)",1); return null; }
            else{
                Log.log("Error (38)",1); return null;
            }

            if(nonce_1 != nonce+1) {
                Log.log("Error (39)",1); return null;
            }
            Log.log("Received: <<Nonce+1,Session Key>> Nonce+1: "+nonce_1,1);
            ...
            //============================================================================= #3 out
                ...
                catch(Exception e){Log.log("Error (310)",1); return null;}
...
//				line = this.create_response(responseLine);
//				System.out.println("Client said: "+line);
//				os.println(line);
//
//				// check finished conditions
//				if(line.equals("end"))
//					return responseLine;
//	    	}
//	    }
//	    else return "Connect Error";
	...
	/******************************************************************************
	 * connects to a server at port_number and host
	 * @param port_number
	 * @param host
	 * @return
	 * @throws Exception
	...
	public String connect(int port_number, String host){
	    ...
	    if (clientSocket != null && os != null && is != null) {
	    	...
	    	os.println("this is the first message to the server ");
	 ...
	 * @return
	 ****************************************************************************/
	private String create_response(String responseLine){
		if(this.i == 5) return "end";
		return "this is the client response # "+this.i++ +" to: "+responseLine;
	}
