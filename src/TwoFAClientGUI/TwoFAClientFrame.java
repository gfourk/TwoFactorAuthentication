...
public class TwoFAClientFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanel1Layout.createSequentialGroup()
										.addComponent(PINfield, javax.swing.GroupLayout.PREFERRED_SIZE, 116,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(18, 18, 18)
										.addComponent(registerButton, javax.swing.GroupLayout.PREFERRED_SIZE, 111,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(OTPButton, javax.swing.GroupLayout.PREFERRED_SIZE, 107,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGroup(jPanel1Layout.createSequentialGroup()
										...
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(Portfield, javax.swing.GroupLayout.PREFERRED_SIZE, 116,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGroup(jPanel1Layout.createSequentialGroup()
										.addComponent(usernamefield, javax.swing.GroupLayout.PREFERRED_SIZE, 116,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(jLabel3).addGap(4, 4, 4)
										.addComponent(passwordfield, javax.swing.GroupLayout.PREFERRED_SIZE, 102,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(jButton1, javax.swing.GroupLayout.DEFAULT_SIZE, 66,
												Short.MAX_VALUE)))
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(jLabel1)
						...
						.addGap(30, 30, 30)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(PINfield, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel4).addComponent(registerButton).addComponent(OTPButton))
						.addGap(26, 26, 26)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
	...
	private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_registerButtonActionPerformed
		...
		if (this.PINfield.getText() == null || this.PINfield.getText().equals("")) {
			JOptionPane.showMessageDialog(this, "PIN required", "Give me a PIN", JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		String reg_number = this.client.register(this.PINfield.getText(), this.Portfield.getText(),
				this.IPfield.getText());
		if (reg_number == null) {
			JOptionPane.showMessageDialog(this, "ERROR registering.", "Error registering", JOptionPane.ERROR_MESSAGE);
			return;
		} else {
			JOptionPane.showMessageDialog(this, "Registration Number:" + reg_number, "Registration Successfull.",
	...
	private void OTPButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_OTPButtonActionPerformed
		...
		if (OTP == null) {
			JOptionPane.showMessageDialog(this, "ERROR getting OTP.", "Error getting OTP", JOptionPane.ERROR_MESSAGE);
			return;
		} else {
			JOptionPane.showMessageDialog(this, "OTP : " + OTP, "karamba", JOptionPane.INFORMATION_MESSAGE);
			return;
		}
